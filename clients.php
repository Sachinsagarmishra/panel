...
<div class="filters fade-in">
    <div class="filter-group">
        <form method="GET" style="display: flex; gap: 1rem; align-items: center;">
            <input type="text" name="search" class="form-input" placeholder="Search clients, brands, countries..."
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
                                ...
                                <!--</button>-->
                                <button onclick="editClient(<?php echo $client['id']; ?>)" class="action-btn btn-secondary"
                                    title="Edit Client">
