            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                <div>
                    <div class="form-group">
                        ...
                        <input type="text" id="code" name="code" class="form-input" placeholder="USD, INR, AED..."
                            maxlength="10" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="name">Currency Name *</label>
                        <input type="text" id="name" name="name" class="form-input" placeholder="US Dollar" required>
                    </div>
                </div>
                ...
                <div>
                    <div class="form-group">
                        ...
                        <input type="text" id="symbol" name="symbol" class="form-input" placeholder="$, ₹, د.إ..."
                            maxlength="10" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="exchange_rate">Exchange Rate to USD *</label>
                        <input type="number" id="exchange_rate" name="exchange_rate" class="form-input" step="0.0001"
                            min="0" placeholder="1.0000" required>
