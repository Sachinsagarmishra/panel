                ...
                <div class="payment-card-body">
                    <?php if ($method['qr_code']): ?>
                        <div class="qr-code-box">
                            <img src="<?php echo htmlspecialchars($method['qr_code']); ?>" class="qr-code-img">
                        </div>
                    <?php endif; ?>
                    <div style="flex: 1;">
                        <div class="payment-detail-group">
                            <div class="payment-detail-label">UPI ID</div>
                            <div class="payment-detail-value"><?php echo htmlspecialchars($method['upi_id']); ?></div>
                        </div>
                        <div class="payment-detail-group">
                            <div class="payment-detail-label">Bank Details</div>
                            <div class="payment-detail-value" style="font-size: 0.85rem; color: #475569;">
                                <?php echo nl2br(htmlspecialchars($method['bank_details'])); ?></div>
                        </div>
                    </div>
                </div>
            </div>
