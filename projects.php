            ...
            <?php if (empty($projects)): ?>
                <tr>
                    <td colspan="6" style="text-align: center; color: #64748b; padding: 3rem;">
                        ...
                        <a href="add-project.php" class="btn btn-primary" style="margin-top: 1rem;">➕ Add
                            Project</a>
                    </td>
                </tr>
            <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
                                <button onclick="viewProject(<?php echo $project['id']; ?>)" class="action-btn btn-secondary"
                                    title="View Details">
                                    <i class="fa-regular fa-eye"></i>
                                </button>
                                <button onclick="editProject(<?php echo $project['id']; ?>)" class="action-btn btn-secondary"
                                    title="Edit Project">
                                    <i class="fa-regular fa-pen-to-square"></i>
                                </button>
                                <button onclick="updateStatus(<?php echo $project['id']; ?>)" class="action-btn btn-success"
                                    title="Update Status">
