                ...
                <div class="form-content">
                    ...
                    <form method="POST" id="invoiceFormElement">
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="client_id" name="client_id" class="form-select" required onchange="loadClientProjects()">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="currency" name="currency" class="form-select" required onchange="updateCurrencySymbol()">
                                        <?php foreach ($activeCurrencies as $curr): ?>
                                            <option value="<?php echo $curr['code']; ?>" data-symbol="<?php echo $curr['symbol']; ?>" 
                                                ...
                                                <?php echo $curr['symbol']; ?> <?php echo $curr['code']; ?> - <?php echo $curr['name']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="items-header" style="display: grid; grid-template-columns: 2fr 100px 120px 120px 50px; gap: 1rem; margin-bottom: 0.5rem; font-weight: 600; color: #64748b; font-size: 0.875rem;">
                                <div>Description</div>
                                <div>Qty</div>
                            ...
                            <div id="invoiceItems">
                                <div class="invoice-item" data-index="0">
                                    <div class="item-row" style="display: grid; grid-template-columns: 2fr 100px 120px 120px 50px; gap: 1rem; align-items: center; margin-bottom: 1rem; padding: 1rem; background: #f8fafc; border-radius: 8px;">
                                        ...
                                        <div>
                                            <button type="button" onclick="removeItem(0)" class="btn btn-secondary" style="padding: 0.5rem; background: #ef4444; color: white;" title="Remove Item"><i class="fa-regular fa-trash-can"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="total-section" style="text-align: right; padding: 1rem; background: #f8fafc; border-radius: 8px; margin-top: 1rem;">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="notes" name="notes" class="form-textarea" 
                                      rows="3" placeholder="Any additional notes for this invoice..."></textarea>
                        </div>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div style="color: #64748b; font-size: 0.75rem;">
                                            <?php echo ($invoice['currency'] ?? 'USD'); ?> - Created: <?php echo date('M j, Y', strtotime($invoice['created_at'])); ?>
                                        </div>
                                    </td>
                                    <td>
                                            ...
                                            <div style="display: flex; gap: 0.25rem;">
                                                <?php if ($invoice['status'] != 'Paid'): ?>
                                                    <button onclick="markAsPaid(<?php echo $invoice['id']; ?>)" 
                                                            class="action-btn btn-success" title="Mark as Paid">
                                                        <i class="fa-regular fa-thumbs-up"></i>
                                                    </button>
                                                <?php else: ?>
                                                    <button onclick="markAsUnpaid(<?php echo $invoice['id']; ?>)" 
                                                            class="action-btn btn-warning" title="Mark as Unpaid">
